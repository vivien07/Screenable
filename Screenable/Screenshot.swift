...
//represents the user's settings; the NSCoding Protocol allows the data type to be loaded and saved
class Screenshot: NSObject , NSCoding {
    ...
    override init() {
        //empty initializer : each new instance has default values
    }
    
    required init?(coder aDecoder: NSCoder) {
        
        //Decodes and returns a previously-encoded object associated with the string key.
